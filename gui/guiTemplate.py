...
class MainWindow(object):
    def __init__(self, master):
        ...
        ### general
        self.master.title("similarCoakeGUI".format(self.currfile))
        ...
        self.menubar = MenuBar(self.master, {   'File': {'New': self.new_db, 'Open...': self.load_db, 'Open recent': None, 'Save': self.save_db, 'Save as...': self.saveas_db, '&sep1': None, 'Import': None, 'Export': None, '&sep2': None, 'Quit': self.master.destroy},
                                                'Settings': {'Undo': None, 'Redo': None, '&sep1': None, 'Cut': None, 'Copy': None, 'Paste': None, '&sep2': None, 'Preferences': None},
                                                'Diagnosis': {'Toggle fullscreen': None},
        ...
        self.exp_list.add(['0000', 'Image Acquisition 1', '21.03.2019', 'Completed'])
        self.db.add_experiment('Image Acquisition 1', '21.03.2019', 'Completed')
        self.exp_list.add(['0001', 'Image Acquisition 2', '21.03.2019', 'In progress'])
        self.db.add_experiment('Image Acquisition 2', '21.03.2019', 'In progress')
        self.exp_list.add(['0002', 'Image Acquisition 3', '21.03.2019', 'Planned'])
        self.db.add_experiment('Image Acquisition 3', '21.03.2019', 'Planned')
